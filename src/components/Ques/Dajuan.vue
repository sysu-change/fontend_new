<template>
    <div class="container">
        <h2>答题人:{{sid}}</h2>
        <span class="sp1">答题时间:{{ans_time}}</span><br/>
        <p v-for="(value,index) in tableData">
            <span class="sp2">问题{{index+1}}:</span><br/>
...
export default {
    ...
    methods:{
        getDajuan:function(vm) {
            var axios={method:"get",url:"http://localhost:8082/module/user/get_sid_answer",widthCredentials: false,
